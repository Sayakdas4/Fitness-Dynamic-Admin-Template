<?php
$featured_in_id = $featured_inInfo->featured_in_id;
$image = $featured_inInfo->image;
$description = $featured_inInfo->description;
$link = $featured_inInfo->link;
?>
        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="featured_in" enctype='multipart/form-data' action="<?php echo base_url() ?>editfeatured_inConfig" method="post">
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div class="input-form mt-3">
                                ...
                                <input type="hidden" value="<?php echo $featured_in_id; ?>" name="featured_in_id" id="featured_in_id" />
                                <?php if($image != NULL){ ?>
...
<!-- <script src="<?php //echo assets_url(); ?>assets/js/featured_in.js" type="text/javascript"></script> -->
