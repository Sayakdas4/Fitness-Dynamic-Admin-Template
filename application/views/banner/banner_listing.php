...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
        <!-- <a class="button text-white bg-theme-1 shadow-md mr-2" href="<?php //echo base_url(); ?>addbanner">Add New Banner</a> -->
        <!-- <div class="dropdown">
        ...
        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
            <div class="w-56 relative text-gray-700 dark:text-gray-300">
                <form action="<?php echo base_url() ?>banner_listing" method="POST" id="searchList">
    ...
    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
        <table class="table table-report mt-2">
            ...
            <tbody>
                <?php if(!empty($banners)) { $i=1; foreach($banners as $banner) { ?>
                <tr class="intro-x">
                    <td><?php echo $i ?></td>
                    <td class="font-medium whitespace-no-wrap"><?php echo $banner->title ?></td>
                    <td class="w-40">
                        ...
                        <div class="flex">
                            <div class="w-full h-20 my-5 image-fit">
                                ...
                                <img alt="Image" data-action="zoom" class="w-full tooltip rounded-full" src="<?php echo assets_url(); ?>uploads/<?php echo $banner->image; ?>" title="<?php echo $banner->title ?>">
                            </div>
                        </div>
                        <?php } else { ?>
                        <div class="flex">
                    ...
                    <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                            <a class="flex items-center mr-3 text-theme-10" href="<?php echo base_url().'editbanner/'.$banner->banner_id; ?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                            <!-- <a class="flex items-center text-theme-6" href="javascript:;" data-toggle="modal" data-target="#delete-confirmation-modal" onclick="read_more_banner(<?php //echo $banner->banner_id; ?>)"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a> -->
                        </div>
                    </td>
                </tr>
                <?php $i++; } } ?>
...
<div class="modal" id="delete-confirmation-modal">
    <div class="modal__content">
        ...
        <div class="px-5 pb-8 text-center" id="banner_delete_data">
...
<script type="text/javascript">
    ...
    function read_more_banner(id)
    {
        $.ajax({
           type: 'POST',
           url: '<?php echo base_url().'banner/banner_details'?>',
           data: {'banner_id':id},
           // dataType: "JSON",
           success: function(response) {
                ...
                html+='<a type="button" href="<?php echo base_url() ?>deletebanner/'+data.banner_id+'" class="button w-24 bg-theme-6 text-white">Delete</a>';
                $("#banner_delete_data").html(html);
            }
        });
    }
</script>