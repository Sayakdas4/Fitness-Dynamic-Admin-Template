        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="" enctype='multipart/form-data' action="<?php echo base_url() ?>addbannerConfig" method="post">
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div class="input-form mt-3">
                                ...
                                <input type="text" name="description_one" id="description_one" value="<?php echo set_value('description_one'); ?>" class="input w-full border col-span-4">
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="text" name="description_two" id="description_two" value="<?php echo set_value('description_two'); ?>" class="input w-full border mt-2">
                            </div>
                            <div class="input-form mt-3">
                                <label for="link" class="flex flex-col sm:flex-row"> Link <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600"></span> </label>
                                <input type="url" name="link" id="link" value="<?php echo set_value('link'); ?>" class="input w-full border mt-2">
                            </div>
                        </div>
