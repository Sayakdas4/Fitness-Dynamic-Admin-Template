<?php
$fitness_recipe_id = $fitness_recipeInfo->fitness_recipe_id;
$preferenceID = $fitness_recipeInfo->preferenceID;
$recipe_typeID = $fitness_recipeInfo->recipe_typeID;

// dd($array_macroID);
// dd($array_simplicityID);

$title = $fitness_recipeInfo->title;
$image = $fitness_recipeInfo->image;
$ingredients = $fitness_recipeInfo->ingredients;
$preparations = $fitness_recipeInfo->preparations;
$pro_tip = $fitness_recipeInfo->pro_tip;
$total_time = $fitness_recipeInfo->total_time;
$difficulty = $fitness_recipeInfo->difficulty;
$makes = $fitness_recipeInfo->makes;
$cuisine = $fitness_recipeInfo->cuisine;
$calories = $fitness_recipeInfo->calories;
$fats = $fitness_recipeInfo->fats;
$carb = $fitness_recipeInfo->carb;
$protein = $fitness_recipeInfo->protein; 
?>
        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="fitness_recipe" enctype='multipart/form-data' action="<?php echo base_url() ?>editfitness_recipeConfig" method="post">
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="hidden" value="<?php echo $fitness_recipe_id; ?>" name="fitness_recipe_id" id="fitness_recipe_id" />
                                <!-- <input type="hidden" value="<?php //echo $fitness_recipe_check_box_id; ?>" name="fitness_recipe_check_box_id" id="fitness_recipe_check_box_id" /> -->
                            </div>
                            <div class="input-form mt-3">
                                ...
                                <input type="file" name="image" id="image" value="<?php echo $image; ?>" class="input w-full border mt-2">
                                <?php if($image != NULL){ ?>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <textarea class="input w-full border mt-2" id="ingredients" value="" name="ingredients" placeholder="Type your text here" required><?php echo $ingredients; ?></textarea>
                            </div>
                            <div class="input-form mt-3">
                                ...
                                <textarea class="input w-full border mt-2" id="preparations" value="" name="preparations" placeholder="Type your text here" required><?php echo $preparations; ?></textarea>
                            </div>
                        </div>
                        <div class="grid grid-cols-0 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="text" name="pro_tip" id="pro_tip" value="<?php echo $pro_tip; ?>" class="input w-full border mt-2" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-4 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="text" name="total_time" id="total_time" value="<?php echo $total_time; ?>" class="input w-full border mt-2" required>
                            </div>
                            <div class="input-form mt-3">
                                <label for="difficulty" class="flex flex-col sm:flex-row"> Difficulty <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600">*</span> </label>
                                <input type="text" name="difficulty" id="difficulty" value="<?php echo $difficulty; ?>" class="input w-full border mt-2" required>
                            </div>
                            <div class="input-form mt-3">
                                <label for="makes" class="flex flex-col sm:flex-row"> Makes <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600">*</span> </label>
                                <input type="text" name="makes" id="makes" value="<?php echo $makes; ?>" class="input w-full border mt-2" required>
                            </div>
                            <div class="input-form mt-3">
                                <label for="cuisine" class="flex flex-col sm:flex-row"> Cuisine <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600">*</span> </label>
                                <input type="text" name="cuisine" id="cuisine" value="<?php echo $cuisine; ?>" class="input w-full border mt-2" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-4 gap-2">
                            <div class="input-form mt-3">
                                <label for="calories" class="flex flex-col sm:flex-row"> Calories <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600">*</span> </label>
                                <input type="text" name="calories" id="calories" value="<?php echo $calories; ?>" class="input w-full border mt-2" required>
                            </div>
                            <div class="input-form mt-3">
                                <label for="fats" class="flex flex-col sm:flex-row"> Fats <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600">*</span> </label>
                                <input type="text" name="fats" id="fats" value="<?php echo $fats; ?>" class="input w-full border mt-2" required>
                            </div>
                            <div class="input-form mt-3">
                                <label for="carb" class="flex flex-col sm:flex-row"> Carb <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600">*</span> </label>
                                <input type="text" name="carb" id="carb" value="<?php echo $carb; ?>" class="input w-full border mt-2" required>
                            </div>
                            <div class="input-form mt-3">
                                <label for="protein" class="flex flex-col sm:flex-row"> Protein <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600">*</span> </label>
                                <input type="text" name="protein" id="protein" value="<?php echo $protein; ?>" class="input w-full border mt-2" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-4 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <div class="flex items-center text-gray-700 dark:text-gray-500 mt-2">
                                    <input type="radio" name="preferenceID" id="preferenceID" class="input border mr-2" value="<?=$preference->preference_id?>" <?php echo ($preferenceID==$preference->preference_id)?'checked':'' ?>> 
                            ...
                            <div class="input-form mt-3">
                                ...
                                <div class="flex items-center text-gray-700 dark:text-gray-500 mt-2">
                                    <input type="radio" name="recipe_typeID" id="recipe_typeID" class="input border mr-2" value="<?=$recipe_type->recipe_type_id?>" <?php echo ($recipe_typeID==$recipe_type->recipe_type_id)?'checked':'' ?>> 
                        ...
                        <div class="grid grid-cols-2 gap-2"> -->
                            <div class="input-form mt-3">
                                ...
                                <div class="flex items-center text-gray-700 dark:text-gray-500 mt-2"> 
                                    <input type="checkbox" class="input border mr-2" name="macroID[]" id="macroID" value="<?=$macro_preference->macro_preference_id?>" <?php if(in_array($macro_preference->macro_preference_id, $array_macroID)) echo "checked" ?>> 
                            ...
                            <div class="input-form mt-3">
                                ...
                                <div class="flex items-center text-gray-700 dark:text-gray-500 mt-2"> 
                                    <input type="checkbox" class="input border mr-2" name="simplicityID[]" id="simplicityID" value="<?=$simplicity_factor->simplicity_factor_id?>" <?php if(in_array($simplicity_factor->simplicity_factor_id, $array_simplicityID)) echo "checked" ?>> 
