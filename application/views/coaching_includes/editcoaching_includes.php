<?php
$coaching_includes_id = $coaching_includesInfo->coaching_includes_id;
$type = $coaching_includesInfo->type;
$left_top = $coaching_includesInfo->left_top;
$left_bottom = $coaching_includesInfo->left_bottom;
$right_top = $coaching_includesInfo->right_top;
$right_bottom = $coaching_includesInfo->right_bottom;
$image = $coaching_includesInfo->image;
?>
        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="coaching_includes" enctype='multipart/form-data' action="<?php echo base_url() ?>editcoaching_includesConfig" method="post">
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <select name="type" id="type" value="<?php echo $type; ?>" class="input tail-select w-full border col-span-4 required" placeholder="John Legend" required selected>
                                    <option value="<?php echo $type; ?>">
                                        <?php
                                            if($type==1){ echo "Nutrition"; }
                                            if($type==2){ echo "Workout"; }
                                            if($type==3){ echo "Mentorship"; }
                                            echo set_value('type'); 
                                        ?>
                                    </option>
                                ...
                                <input type="hidden" value="<?php echo $coaching_includes_id; ?>" name="coaching_includes_id" id="coaching_includes_id" />
                            </div> 
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="text" name="left_top" id="left_top" value="<?php echo $left_top; ?>" class="input w-full border mt-2" required>
                            </div>
                            <div class="input-form mt-3">
                                <label for="right_top" class="flex flex-col sm:flex-row"> Right Top <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600">*</span> </label>
                                <input type="text" name="right_top" id="right_top" value="<?php echo $right_top; ?>" class="input w-full border mt-2" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="text" name="left_bottom" id="left_bottom" value="<?php echo $left_bottom; ?>" class="input w-full border mt-2" required>
                            </div>
                            <div class="input-form mt-3">
                                ...
                                <input type="text" name="right_bottom" id="right_bottom" value="<?php echo $right_bottom; ?>" class="input w-full border mt-2" required>
                            </div>
                        </div>
                        <div class="input-form mt-3">
...
<!-- <script src="<?php //echo assets_url(); ?>assets/js/coaching_includes.js" type="text/javascript"></script> -->
