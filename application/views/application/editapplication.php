            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" enctype='multipart/form-data' action="<?php echo base_url() ?>editapplicationConfig" method="post" id="application" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group" id="area">
                                        ...
                                        <textarea class="form-control" id="description" value="" name="description" placeholder="Write your text here"><?php echo $description; ?></textarea>
                                    </div>
                                </div> 
                            </div>
                            <div class="row">
