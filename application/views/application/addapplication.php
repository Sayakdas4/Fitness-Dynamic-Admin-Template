            ...
            <div class="col-md-8">
              <!-- general form elements -->            
                <div class="box box-primary">
                    ...
                    <form role="form" id="application" enctype='multipart/form-data' action="<?php echo base_url() ?>addapplicationConfig" method="post">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="title">Title</label><span class="text-red">*</span>
                                        <input type="text" class="form-control" value="<?php echo set_value('title'); ?>" id="title" name="title" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group" id="area">
                                        ...
                                        <textarea class="form-control" id="description" value="<?php echo set_value('description'); ?>" name="description" placeholder="Write your text here"></textarea>
                                    </div>
                                </div> 
                            </div>                            
                            <div class="row">
...
<script src="<?php echo assets_url(); ?>assets/js/application.js" type="text/javascript"></script>
