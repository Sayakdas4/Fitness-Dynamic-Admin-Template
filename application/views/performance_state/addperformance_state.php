        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="performance_state" enctype='multipart/form-data' action="<?php echo base_url() ?>addperformance_stateConfig" method="post">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                <label for="count" class="flex flex-col sm:flex-row"> Count <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600">*</span> </label>
                                <input type="text" name="count" id="count" value="<?php echo set_value('count'); ?>" class="input w-full border col-span-4" required>
                                <div id="msg"></div>
                            </div>
                        </div>
                        <div class="input-form mt-3">
...
<!-- <script src="<?php //echo assets_url(); ?>assets/js/performance_state.js" type="text/javascript"></script> -->
