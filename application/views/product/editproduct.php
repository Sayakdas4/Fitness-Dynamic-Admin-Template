...
$page_slug = $productInfo->page_slug;
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" enctype='multipart/form-data' action="<?php echo base_url() ?>editproductConfig" method="post" id="product" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="title">Select Category</label><span class="text-red">*</span>
                                        <select class="form-control required" id="category_id" name="category_id">
                                            <?php foreach($category as $cat){ ?>
                                            <option value="<?=$cat->product_category_id?>" <?php if($category_id==$cat->product_category_id){ ?> selected="selected" <?php } ?>><?php echo $cat->product_category_title; ?></option> 
                                            <?php } ?>
                                        </select>
...
<!-- <script src="<?php echo assets_url(); ?>assets/js/product.js" type="text/javascript"></script> -->
