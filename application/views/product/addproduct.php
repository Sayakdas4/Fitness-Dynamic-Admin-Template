            ...
            <div class="col-md-8">
              <!-- general form elements -->            
                <div class="box box-primary">
                    ...
                    <form role="form" id="product" enctype='multipart/form-data' action="<?php echo base_url() ?>addproductConfig" method="post">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="category_id">Product Category</label><span class="text-red">*</span>
                                        <select class="form-control required" id="category_id" name="category_id">
                                            <option value="0">Select Category</option>
                                            <?php foreach($category as $cat){ ?>
                                            <option value="<?=$cat->product_category_id?>"><?=$cat->product_category_title?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div> 
                            ...
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo set_value('page_slug'); ?>" id="page_slug" name="page_slug" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group" id="area">
                                        ...
                                        <textarea class="form-control required" id="short_description" value="<?php echo set_value('short_description'); ?>" name="short_description" placeholder="Write your text here"></textarea>
                                    </div>
                                </div> 
                            </div>
                            <div class="row">
