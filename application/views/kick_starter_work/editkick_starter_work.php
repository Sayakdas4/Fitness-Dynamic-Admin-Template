<?php
$kick_starter_work_id = $kick_starter_workInfo->kick_starter_work_id;
$title_one = $kick_starter_workInfo->title_one;
$section_one = $kick_starter_workInfo->section_one;
$title_two = $kick_starter_workInfo->title_two;
$section_two = $kick_starter_workInfo->section_two;
$title_three = $kick_starter_workInfo->title_three;
$section_three = $kick_starter_workInfo->section_three;
$title_four = $kick_starter_workInfo->title_four;
$section_four = $kick_starter_workInfo->section_four;
?>
        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="kick_starter_work" enctype='multipart/form-data' action="<?php echo base_url() ?>editkick_starter_workConfig" method="post">
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="hidden" value="<?php echo $kick_starter_work_id; ?>" name="kick_starter_work_id" id="kick_starter_work_id" />
                            </div>
                            <div class="input-form mt-3">
