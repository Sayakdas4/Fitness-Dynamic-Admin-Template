        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="about_us_management" enctype='multipart/form-data' action="<?php echo base_url() ?>addabout_us_managementConfig" method="post">
