<?php $this->load->view('fincludes/header'); ?>
    ...
    <section class="service-section mt-120">
        <div class="container-fluid p-0">
            <?php if(!empty($services)){ $i=1; foreach($services as $service){ 
                if($i==1) { $order1 = 'order-lg-2'; $order2 =""; }
                if($i==2) { $order2 = 'order-lg-2'; $order1 =""; }
            ?>
            <div class="row">
                <div class="col-md-6 p-0 <?=$order2?>">
                    <div class="section-content">
                        <div class="content-text">
                            <div class="section-title wow bounceInUp">
                                <h2 class="title text-uppercase"><?=$service->title?></span></h2>
                            </div>
                ...
                <div class="col-lg-6 position-relative p-0 <?php echo $order1; if($i==1) {$i++;} else {$i=1;} ?>">
                    <div class="overlap-grid">
                        <div class="item">
                            <img src="<?php echo base_url().'uploads/'.$service->image; ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
