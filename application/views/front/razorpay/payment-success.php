            ...
            <div class="d-flex justify-content-center">
                <div class="bg-white border-rounded-7 dark-grey-text p-35 login-box">
                    <div class="heading text-start pb-0 ">
                        <p class="pb-1 mb-0 text-center text-success"><i class="fas fa-check-circle mr-2"></i> Payment Successfull</p>
                        
                    </div>
                    <div class="forget-pass">
                        <p class="sign-up-text text-center">An automated payment receipt will be sent to your registered email.</p>
