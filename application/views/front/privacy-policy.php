                  ...
                  <div class="single-section-text">
                      <div class="mb-50">
                          <p>
                              ...
                              <span>The Fit Chase.</span>
                          </p>
                      </div>
                      <div class="mb-50 ">
                          <h6 class="dark-bold-text font-25 mb-0">Consent</h6>
                          <p>
                          By using our website, you hereby consent to our Privacy Policy and agree to its terms.
                          </p>
                      </div>
                      <div class="mb-50 ">
                          <h6 class="dark-bold-text font-25 mb-50">Information we collect</h6>
                          <p>
                              ...
                              phone number, the contents of the message and/or attachments you may send us, and any other information you may choose to provide.<br><br>
                      ...
                      <div class="mb-50 ">
                          <h6 class="dark-bold-text font-25 mb-0">How we use your information</h6>
                          <p class="mb-0">
                      ...
                      <div class="mb-50 ">
                          <h6 class="dark-bold-text font-25 mb-0">Log files</h6>
                          <p>
                            The Fit Chasese follows a standard procedure of using log files. These files log visitors when they visit websites. 
                      ...
                      <div class="mb-50 ">
                          <h6 class="dark-bold-text font-25 mb-0">Cookies &amp; web beacons</h6>
                          <p>
                            Like any other website, The Fit Chase uses ‘cookies’. These cookies are used to store information 
                      ...
                      <div class="mb-50 ">
                          <h6 class="dark-bold-text font-25 mb-0">Third-party privacy policies</h6>
                          <p>
                            The Fit Chase’s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the 
                            ...
                            options. To know more detailed information about cookie management with specific web browsers, it can be 
                            found at the browsers’ respective websites.
                          </p>
                      </div>
                      <div class="mb-50 ">
                          <h6 class="dark-bold-text font-25 mb-0">CCPA privacy rights</h6>
                          <p>
                      ...
                      <div class="mb-50">
                          <h6 class="dark-bold-text font-25 mb-0">GDPR data protection rights</h6>
                          <p>
