        ...
        <div class="container">
            ...
            <div class="row">
                                ...
                                <ul class="list-inline mb-0 item-block-2 ul_macro_preference">
                                    ...
                                    <li class="item list-inline-item">
                                        ...
                                        <article class="feature1">
                                            <input type="checkbox" class="input filter_macroID" name="filter_macroID[]" id="filter_macroID" value="<?=$macro_preference->macro_preference_id?>" data-macro-preference="<?=$recipe_type->recipe_type_id?>">
                            ...
                            <div class="items">
                                <ul class="list-inline mb-0 item-block-multiple ul_simplicity">
                                    <?php if(!empty($simplicity_factors)){ $i=1; foreach($simplicity_factors as $simplicity_factor){ 
                                        ...
                                        if($i==4) { $number = 'one'; }
                                    ?>
                                    <li class="item list-inline-item <?=$number?>"><a href="javascript:;" data-simplicity="<?=$simplicity_factor->simplicity_factor_id?>" class="simplicity_active"><?=$simplicity_factor->simplicity_factor_title?></a></li>
                                    <?php $i++; } } ?>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-sm-12 col-md-8 col-lg-9">
                            ...
                            <div class="recepie-item-block">
                                <div class="recepie-content">
                                    ...
                                    <div class="recepie-details">
                                        ...
                                        <div class="item-name"><a style="color: #000000;" href="<?php echo base_url().'fitness-recipe-details/'.$fitness_recipe->fitness_recipe_id; ?>"><?php echo limit_text($fitness_recipe->title, 5); ?></a></div>
                                        <div class="timings">
                    ...
                    <div class="next-prev d-flex justify-content-between pt-2 padbot-200">
...
<script type="text/javascript">
    ...
    function filter_fitness_recipe(filter_macroID = null)
    {
        ...
        $.ajax({
           ...
           data: {'preferenceID':preferenceID, 'recipe_typeID':recipe_typeID, 'simplicityID':simplicityID, 'filter_macroID':filter_macroID},
           // dataType: "JSON",
