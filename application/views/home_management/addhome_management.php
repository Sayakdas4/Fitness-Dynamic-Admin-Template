        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="home_management" enctype='multipart/form-data' action="<?php echo base_url() ?>addhome_managementConfig" method="post">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="text" name="subtitle_one" id="subtitle_one" value="<?php echo set_value('subtitle_one'); ?>" class="input w-full border col-span-4 required" placeholder="John Legend" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="text" name="subtitle_two" id="subtitle_two" value="<?php echo set_value('subtitle_two'); ?>" class="input w-full border col-span-4 required" placeholder="John Legend" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
