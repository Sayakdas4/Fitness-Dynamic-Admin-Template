<?php
$kick_starter_includes_id = $kick_starter_includesInfo->kick_starter_includes_id;
$type = $kick_starter_includesInfo->type;
$left_top = $kick_starter_includesInfo->left_top;
$left_bottom = $kick_starter_includesInfo->left_bottom;
$right_top = $kick_starter_includesInfo->right_top;
$right_bottom = $kick_starter_includesInfo->right_bottom;
$image = $kick_starter_includesInfo->image;
?>
        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="kick_starter_includes" enctype='multipart/form-data' action="<?php echo base_url() ?>editkick_starter_includesConfig" method="post">
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="hidden" value="<?php echo $kick_starter_includes_id; ?>" name="kick_starter_includes_id" id="kick_starter_includes_id" />
                            </div> 
                        </div>
