            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" enctype='multipart/form-data' action="<?php echo base_url() ?>editclientConfig" method="post" id="client" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
...
<!-- <script src="<?php echo assets_url(); ?>assets/js/client.js" type="text/javascript"></script> -->
