  ...
  <section class="usp about-title">
    <div class="container-fluid">
      <div class="usp-page">
        <h3>SHADE CARD</h3>
        <h2><?=$cms5->title?></h2>
        <p><?=$cms5->description?></p>
      </div>
      <div class="section-heading text-center pb-30">
        <ul class="shades-ul">
          <?php if(!empty($type_2)) { foreach($type_2 as $ral) { ?>
          <li class="shades-li" style="CURSOR: pointer; HEIGHT:  75px; FONT-FAMILY: Arial; font-size: 15px;  VERTICAL-ALIGN: top; COLOR: white; PADDING-BOTTOM: 2px; PADDING-TOP: 2px; BACKGROUND-COLOR: <?=$ral->color?>">
            <div id="div2037"><small style="text-shadow: 1px 1px 1px #3c3c3c;">&nbsp;&nbsp;&nbsp;<?=$ral->title?></small></div></li>
          <?php } } ?>
        </ul>
      </div>
    </div>
