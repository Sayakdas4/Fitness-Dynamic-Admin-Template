            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" enctype='multipart/form-data' action="<?php echo base_url() ?>editpartnerConfig" method="post" id="partner" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $partner_id; ?>" name="partner_id" id="partner_id" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<!-- <script src="<?php echo assets_url(); ?>assets/js/partner.js" type="text/javascript"></script> -->
