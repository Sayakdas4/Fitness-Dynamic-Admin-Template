<?php
$coaching_pricing_id = $coaching_pricingInfo->coaching_pricing_id;
$duration = $coaching_pricingInfo->duration;
$duration_format = $coaching_pricingInfo->duration_format;
$price = $coaching_pricingInfo->price;
?>
        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="coaching_pricing" enctype='multipart/form-data' action="<?php echo base_url() ?>editcoaching_pricingConfig" method="post">
                        <div class="grid grid-cols-0 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <div class="relative mt-2">
                                    ...
                                    <input type="hidden" value="<?php echo $coaching_pricing_id; ?>" name="coaching_pricing_id" id="coaching_pricing_id" />
