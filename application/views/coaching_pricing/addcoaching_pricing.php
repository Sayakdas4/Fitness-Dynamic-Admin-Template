        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="coaching_pricing" enctype='multipart/form-data' action="<?php echo base_url() ?>addcoaching_pricingConfig" method="post">
                        <div class="grid grid-cols-0 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <div class="relative mt-2">
                                    <input type="number" name="duration" id="duration" value="<?php echo set_value('duration'); ?>" class="input pr-16 w-full border col-span-4" required>
                                    <div class="absolute top-0 right-0 rounded-r w-25 h-full flex items-center justify-center bg-gray-100 dark:bg-dark-1 dark:border-dark-4 border text-gray-600">
                                        <select class="tail-select w-full" name="duration_format" id="duration_format" value="<?php echo set_value('duration_format'); ?>" required>
                        ...
                        <div class="grid grid-cols-0 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <div class="relative mt-2">
                                    ...
                                    <div class="pl-3">
                                        <input type="number" name="price" id="price" class="input pl-12 w-full border col-span-4" value="<?php echo set_value('price'); ?>" placeholder="Price" required>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- <script src="<?php //echo assets_url(); ?>assets/js/coaching_pricing.js" type="text/javascript"></script> -->
