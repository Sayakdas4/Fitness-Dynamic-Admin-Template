<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-sticky-note"></i> Shades Card
        <small>Add</small>
      </h1>
    </section>
            ...
            <div class="col-md-8">
              <!-- general form elements -->            
                <div class="box box-primary">
                    ...
                    <form role="form" id="shades" enctype='multipart/form-data' action="<?php echo base_url() ?>addshadesConfig" method="post">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        ...
                                        <input type="color" class="form-control required" value="<?php echo set_value('color'); ?>" id="color" name="color" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo set_value('name'); ?>" id="name" name="name" >
                                    </div>
                                </div>
                            </div>
                        </div>
