<?php
$site_settings_id = $site_settingsInfo->site_settings_id;
$title = $site_settingsInfo->title;
$description = $site_settingsInfo->description;
$image = $site_settingsInfo->image;
?>

<div class="intro-y flex items-center mt-8">
    <?php if($site_settings_id == 4){ ?>
        <h2 class="text-lg font-medium mr-auto">
            <i class="fa fa-google"></i> Google Analytics
        </h2>
    <?php } if($site_settings_id == 3) { ?>
        <h2 class="text-lg font-medium mr-auto">
            <i class="fa fa-drupal"></i> Logo
        </h2>
    <?php } if($site_settings_id == 5) { ?>
        <h2 class="text-lg font-medium mr-auto">
            <i class="fa fa-question-circle"></i> Export Enquiries
        </h2>
    <?php } if($site_settings_id != 5 && $site_settings_id != 4 && $site_settings_id != 3) { ?>
        <h2 class="text-lg font-medium mr-auto">
            <i class="fa fa-shield"></i> site_settings
            <small>Edit</small>
        </h2>
    <?php } ?>
        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="" enctype='multipart/form-data' action="<?php echo base_url() ?>editsite_settingsConfig" method="post">
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="hidden" value="<?php echo $site_settings_id; ?>" name="site_settings_id" id="site_settings_id" />
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
