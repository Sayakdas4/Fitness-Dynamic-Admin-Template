            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" enctype='multipart/form-data' action="<?php echo base_url() ?>editvideoConfig" method="post" id="video" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $video_id; ?>" name="video_id" id="video_id" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group" id="area">
                                        <label for="link">Description</label><span class="text-red">*</span>
                                        <textarea class="form-control required" id="link" value="" name="link" placeholder="Write your text here"><?php echo $link; ?></textarea>
                                    </div>
                                </div> 
                            </div>
