<?php
$cms_id = $cmsInfo->cms_id;
$title = $cmsInfo->title;
$page_slug = $cmsInfo->page_slug;
$description = $cmsInfo->description;
$image = $cmsInfo->image;
$meta_title = $cmsInfo->meta_title;
$meta_description = $cmsInfo->meta_description;
$meta_tag = $cmsInfo->meta_tag;
?>
        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="" enctype='multipart/form-data' action="<?php echo base_url() ?>editcmsConfig" method="post">
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="hidden" value="<?php echo $cms_id; ?>" name="cms_id" id="cms_id" />
                            </div>
                            <div class="input-form mt-3">
                                <label for="page_slug" class="flex flex-col sm:flex-row"> Page Slug <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600">*</span> </label>
                                <input type="text" name="page_slug" id="page_slug" value="<?php echo $page_slug; ?>" class="input w-full border col-span-4" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-3 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="url" name="meta_title" id="meta_title" value="<?php echo $meta_title; ?>" class="input w-full border mt-2" placeholder="">
                            </div>
                            <div class="input-form mt-3">
                                ...
                                <textarea type="url" name="meta_description" id="meta_description" value="<?php echo $meta_description; ?>" class="input w-full border mt-2" placeholder="Type your text here"></textarea>
                            </div>
                            <div class="input-form mt-3">
                                <label for="meta_tag" class="flex flex-col sm:flex-row"> Meta Tag <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600"></span> </label>
                                <input type="url" name="meta_tag" id="meta_tag" value="<?php echo $meta_tag; ?>" class="input w-full border mt-2" placeholder="">
                            </div>
                        </div>
