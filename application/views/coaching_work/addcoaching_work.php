        ...
        <div class="intro-y box">
            ...
            <div class="p-5" id="form-validation">
                <div class="preview">
                    ...
                    <form role="form" class="validate-form" id="coaching_work" enctype='multipart/form-data' action="<?php echo base_url() ?>addcoaching_workConfig" method="post">
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="text" name="section_one" id="section_one" value="<?php echo set_value('section_one'); ?>" class="input w-full border col-span-4 required" placeholder="John Legend" required>
                            </div>
                            <div class="input-form mt-3">
                                <label for="section_two" class="flex flex-col sm:flex-row"> Section 2 <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600">*</span> </label>
                                <input type="text" name="section_two" id="section_two" value="<?php echo set_value('section_two'); ?>" class="input w-full border col-span-4" required>
                                <div id="msg"></div>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-2">
                            <div class="input-form mt-3">
                                ...
                                <input type="text" name="section_three" id="section_three" value="<?php echo set_value('section_three'); ?>" class="input w-full border col-span-4 required" placeholder="John Legend" required>
                            </div>
                            <div class="input-form mt-3">
                                <label for="section_four" class="flex flex-col sm:flex-row"> Section 4 <span class="sm:ml-1 mt-1 sm:mt-0 text-red-600">*</span> </label>
                                <input type="text" name="section_four" id="section_four" value="<?php echo set_value('section_four'); ?>" class="input w-full border col-span-4" required>
                                <div id="msg"></div>
                            </div>
                        </div>
                        <div class="input-form mt-3">
