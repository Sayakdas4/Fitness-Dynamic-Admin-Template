<?php
$usp_id = $uspInfo->usp_id;
$title = $uspInfo->title;
$description = $uspInfo->description;
$image = $uspInfo->image;
?>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" enctype='multipart/form-data' action="<?php echo base_url() ?>edituspConfig" method="post" id="usp" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $usp_id; ?>" name="usp_id" id="usp_id" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <img src="<?php echo base_url('uploads/'.$image); ?>" width="97" height="100">
                                    </div>
                                </div>
                            </div>
...
<!-- <script src="<?php echo assets_url(); ?>assets/js/usp.js" type="text/javascript"></script> -->
