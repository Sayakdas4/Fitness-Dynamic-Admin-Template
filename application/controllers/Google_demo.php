    ...
    function google_signin()
    {
        ...
        if(isset($_GET["code"]))
        {
            ...
            if(!isset($token["error"]))
            {
                ...
                {
                    if($this->signin_model->check_email($data['email']) == FALSE){
                        //insert data
                        $user_data = array(
                        ...
                        $email_data = $this->signin_model->get_email_id($data['email']);
                        //update data
                        if($email_data){
                            $user_data = array(
                                'login_oauth_uid' => $data['id'],
                            ...
                            $this->signin_model->update_user_login($user_data, $email_data->user_id);
                        }
                    }
                }
