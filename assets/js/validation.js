...
$(document).ready(function(){
    ...
    jQuery.validator.addMethod("notEqualTo", function(value, element)
       ...
       {
           var response;
           var post_url_check_username = baseurl + "team/check_username/";
       ...
       jQuery.validator.addMethod("checkMonthExist", function(value, element)
       {
           var response = false;
           
           var post_url_check_month = baseurl +"user/checkMonthExist/";
           
           $.ajax({
                  type: "POST",
                  url: post_url_check_month,
                  data: {s_month : value},
                  dataType: "json",
                  async: false
           }).done(function(result){
  ...
  jQuery.validator.addMethod("checkEmailMonthFranchise", function(value, element)
       {
           var response = false;
           
           var post_url_check_month_franchise = baseurl +"franchise/franchise/checkMonthExist/";
           
           $.ajax({
                  type: "POST",
                  url: post_url_check_month_franchise,
                  data: {month : value},
                  dataType: "json",
                  async: false
           }).done(function(result){
